...
export default function About() {
  ...
  return (
    <div className="bg-white text-gray-900 font-sans selection:bg-emerald-600 selection:text-white">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[50vh] sm:min-h-[60vh] lg:min-h-[75vh] w-full flex flex-col justify-center overflow-hidden bg-gray-900">
        {heroImage && (
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-8 py-16 sm:py-24 pt-24 sm:pt-32">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-[1.3] md:leading-snug mb-2 md:mb-4">
              Membangun Masa Depan Pendidikan Indonesia Lewat Data & Aksi
            </h1>

            <p className="text-xs sm:text-sm md:text-base text-gray-300 leading-relaxed font-light mb-4 md:mb-8 line-clamp-2 md:line-clamp-none">
      ...
      {/* 2. STATS STRIP */}
      <section className="bg-white py-4 sm:py-8 md:py-16 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-4 gap-1 sm:gap-4 md:gap-8 text-center divide-x divide-gray-100">
            {[
              ...
              { value: '7', suffix: '+', label: 'Mitra Kolaborator' }
            ].map((stat, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <h3 className="text-sm sm:text-2xl md:text-5xl font-black text-gray-900 mb-1 sm:mb-2 tracking-tight leading-none">
                  {stat.value}<span className="text-emerald-600">{stat.suffix}</span>
                </h3>
                <p className="text-[8px] sm:text-[9px] md:text-xs text-gray-500 uppercase font-bold tracking-wider leading-tight mt-1 sm:mt-2">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* 3. THE CORE VALUES */}
      <section className="py-8 sm:py-24 lg:py-32 bg-[#F8FBF9]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div {...fadeUp} className="text-center max-w-3xl mx-auto mb-6 sm:mb-16 md:mb-20">
            <h2 className="text-xl sm:text-3xl md:text-5xl font-black text-gray-900 mb-2 sm:mb-6 tracking-tight">The Core Values</h2>
            <p className="text-gray-600 text-xs sm:text-base md:text-xl font-light leading-relaxed">
              Sekolah Tanah Air memiliki nilai keyakinan bersama dengan harapan membangun masa depan pendidikan Indonesia.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-10">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-4 sm:p-10 rounded-2xl shadow-sm border border-gray-100 flex flex-row sm:flex-col items-start sm:items-center text-left sm:text-center hover:border-emerald-100 transition-all hover:shadow-md"
              >
                <div className="w-10 h-10 sm:w-16 sm:h-16 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-700 mr-3.5 sm:mr-0 sm:mb-6 shrink-0">
                  <val.icon className="w-5 h-5 sm:w-7 sm:h-7" strokeWidth={1.5} />
                </div>
                <div className="flex flex-col">
                  <h3 className="text-sm sm:text-2xl font-bold text-gray-900 mb-1 sm:mb-4 leading-snug">{val.title}</h3>
                  <p className="text-xs sm:text-base text-gray-600 leading-relaxed font-light">{val.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-8 sm:py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-24 items-start">
            ...
            <motion.div {...fadeUp} className="lg:col-span-5 lg:sticky lg:top-32">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-emerald-50 text-emerald-700 mb-3 sm:mb-6">
                <Target className="w-5 h-5 sm:w-7 sm:h-7" strokeWidth={1.5} />
              </div>
              <h2 className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-emerald-600 mb-2 sm:mb-4">Visi Kami</h2>
              <h3 className="text-base sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-relaxed text-gray-900 tracking-tight">
            ...
            {/* Misi */}
            <motion.div {...fadeUp} transition={{ delay: 0.2 }} className="lg:col-span-7 space-y-4 sm:space-y-8 md:space-y-12">
              <div className="inline-flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-teal-50 text-teal-700 mb-1 sm:mb-2">
                <Lightbulb className="w-5 h-5 sm:w-7 sm:h-7" strokeWidth={1.5} />
              </div>
              <h2 className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-teal-600 mb-3 sm:mb-6">Misi Kami</h2>
              ...
              <div className="grid gap-3 sm:gap-6">
                {[
                  ...
                  <div key={i} className="flex gap-3 sm:gap-6 bg-[#F8FBF9] p-3.5 sm:p-6 rounded-2xl border border-gray-50">
                    <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 bg-emerald-100/50 rounded-full flex items-center justify-center text-emerald-700 font-bold text-xs sm:text-sm">
                      {i + 1}
                    </div>
                    <div>
                      <h4 className="text-sm sm:text-xl font-bold mb-1 sm:mb-2 text-gray-900">{misi.title}</h4>
                      <p className="text-gray-600 font-light leading-relaxed text-xs sm:text-base">{misi.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
