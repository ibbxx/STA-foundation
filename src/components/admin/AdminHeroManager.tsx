        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => onUpdate(slide.id, 'buttonText', e.target.value)}
              placeholder="Contoh: Donasi Sekarang"
              className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-900 outline-none placeholder:text-slate-300 focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900"
            />
          </div>
          <div>
            <label className="mb-1 block text-[11px] font-bold uppercase tracking-wider text-slate-400">
            ...
            <input
              ...
              onChange={(e) => onUpdate(slide.id, 'buttonLink', e.target.value)}
              placeholder="Contoh: /campaigns atau https://..."
              className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-900 outline-none placeholder:text-slate-300 focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900"
            />
          </div>
        </div>
