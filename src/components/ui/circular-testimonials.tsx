...
interface Testimonial {
  ...
  designation: string;
  src: string;
  href?: string; // Tambahan untuk link ke program
}
...
export const CircularTestimonials = ({
  ...
  return (
    <div className="testimonial-container relative w-full max-w-7xl px-0 py-2 sm:px-4 sm:py-8">
      <div className="testimonial-grid grid gap-4 sm:gap-6 md:gap-20 md:grid-cols-2">
        {/* Images */}
        <div className="image-container relative w-[85%] mx-auto sm:w-full h-[180px] sm:h-[260px] md:h-[400px] lg:h-[500px]" style={{ perspective: '1000px' }} ref={imageContainerRef}>
        ...
        <div className="testimonial-content flex flex-col justify-center space-y-4 md:space-y-8">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="space-y-2">
                <h3
                  className="name font-black tracking-tight"
                  style={{ color: colorName, fontSize: fontSizeName }}
                >
                  {activeTestimonial.name}
                </h3>
                <p
                  className="designation font-bold uppercase tracking-[0.2em] opacity-60"
              ...
              {activeTestimonial.href && (
                ...
                >
                  ...
                  >
                    Eksplorasi Program <FaArrowRight size={12} />
                  </a>
                </motion.div>
              )}
            </motion.div>
          ...
          <div className="arrow-buttons flex gap-4 pt-4">
            ...
            <button
              className="arrow-button next-button w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 border border-transparent shadow-md"
              onClick={handleNext}
              style={{
